...
### # SQL Script that created the .csv
# select distinct PROTOCOL_NUMBER, COUNTRY_NAME, SITE_NUMBER, ORIGINAL_PATIENT_ID,
# SCREENING_NUMBER, VISIT_ID, VISIT_NAME, VISIT_TYPE, VISIT_DATE, VISIT_TIME
# from GRED_IXRS.PATIENT_SCREENING_VISITS
# where Protocol_number in ('GDC4629G')
# --and SITE_NUMBER = 'S24626'
# --and original_patient_ID = '2'
# order by SCREENING_NUMBER, VISIT_DATE;

# Working Directory Shuffle for my laptop
setwd("C:/Users/leerssej/..Google Drive/SQLcode/SankeyData")
dir()

# Read in Data 
SankeySample <- read.csv("IXRS_GDC4629G.csv")
